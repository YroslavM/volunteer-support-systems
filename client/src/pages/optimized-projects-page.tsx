  ...
  const getTabsForRole = () => {
    if (!user || user.role === "donor") {
      return [
        ...
        { value: "active", label: "Активний збір", count: categorizedProjects.active.length },
        { value: "completed", label: "Збір завершено", count: categorizedProjects.completed.length },
      ];
    } else if (user.role === "volunteer") {
      return [
        { value: "all", label: "Всі проєкти", count: categorizedProjects.all.length },
        { value: "participating", label: "Мої проєкти", count: categorizedProjects.participating.length },
        { value: "available", label: "Доступні", count: categorizedProjects.available.length },
      ...
      return [
        { value: "all", label: "Всі проєкти", count: categorizedProjects.all.length },
        { value: "active", label: "Активні", count: categorizedProjects.active.length },
        { value: "completed", label: "Завершені", count: categorizedProjects.completed.length },
      ];
    }
  };
