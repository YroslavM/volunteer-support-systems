      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-xl mb-16">
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-gradient-to-r from-primary/90 to-primary-foreground/50 mix-blend-multiply z-10" />
            <img
              ...
              onError={(e) => {
                ...
                target.parentElement!.style.background = 'linear-gradient(to right, var(--primary), var(--primary-foreground))';
              }}
            />
          </div>
          <div className="relative py-24 px-8 sm:px-16 flex flex-col items-center text-center z-20">
            ...
            <Button className="mt-8 bg-white text-primary hover:bg-gray-100 shadow-lg">
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <img 
                src="https://images.unsplash.com/photo-1569683795645-b62e50fbf103?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80" 
                alt="Волонтерські проєкти"
                className="rounded-lg shadow-md w-full h-80 object-cover"
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  target.onerror = null;
                  target.style.backgroundColor = 'var(--primary-200)';
                }}
              />
            </div>
            <div>
